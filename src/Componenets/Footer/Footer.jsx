...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-[#E8F6EF] text-[#245953]">
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t bg-[#E8F6EF] border-base-300">
                <aside className="items-center grid-flow-col">
                    <BsFilePpt className="font-bold text-2xl"></BsFilePpt>
                    <p>Copyright © 2023 - All right reserved by Phantasy Event Management</p>
                </aside>
