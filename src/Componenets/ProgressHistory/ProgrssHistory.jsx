...
const ProgrssHistory = () => {
    return (
        <div className="bg-[#B2533E] my-9 p-12 ">
            ...
            <div className="pl-12 md:flex md:justify-around md:max-w-6xl md:mx-auto lg:flex justify-around max-w-6xl mx-auto">

                <div className=" md:flex md:flex-col lg:flex flex-col ">
